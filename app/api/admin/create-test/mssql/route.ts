  ...
  try {
    ...
    if (!course) {
      course = await db.course.create({
        data: {
          title: "MSSQL Test Kategorisi",
          description: "MSSQL teknolojisi için test kategorisi",
          expertise,
    ...
    return NextResponse.json({
      success: true,
      message: `MSSQL test kategorisi başarıyla oluşturuldu. Test içeriği daha sonra eklenecek.`,
      stats: {
        testsCreated: 1,
      },
    });
