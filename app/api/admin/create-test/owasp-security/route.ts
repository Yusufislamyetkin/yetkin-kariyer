...
export async function POST() {
  try {
    ...
    try {
      const fileName = TEST_MODULE_FILE_MAP[expertise] || "owasp-security-test-modules.json";
    ...
    return NextResponse.json({
      success: true,
      message: `OWASP Security testleri başarıyla oluşturuldu. ${modules.length} modül, ${totalTests} test eklendi.`,
      stats: {
