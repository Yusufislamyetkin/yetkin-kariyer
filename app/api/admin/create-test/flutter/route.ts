  ...
  try {
    ...
    if (!course) {
      course = await db.course.create({
        data: {
          title: "Flutter Test Kategorisi",
          description: "Flutter teknolojisi için test kategorisi",
          expertise,
    ...
    return NextResponse.json({
      success: true,
      message: `Flutter test kategorisi başarıyla oluşturuldu. Test içeriği daha sonra eklenecek.`,
      stats: {
        testsCreated: 1,
      },
    });
