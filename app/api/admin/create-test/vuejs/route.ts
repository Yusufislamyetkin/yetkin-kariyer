...
export async function POST() {
  try {
    ...
    console.log("[CREATE_TEST_API] Starting Vue.js test creation...");

    const expertise = "Vue.js";
    
    let testContent: any = null;
    try {
      const fileName = TEST_MODULE_FILE_MAP[expertise] || "vuejs-test-modules.json";
    ...
    return NextResponse.json({
      success: true,
      message: `Vue.js testleri başarıyla oluşturuldu. ${modules.length} modül, ${totalTests} test eklendi.`,
      stats: {
