  ...
  try {
    ...
    if (!course) {
      course = await db.course.create({
        data: {
          title: "Next.js Test Kategorisi",
          description: "Next.js teknolojisi için test kategorisi",
          expertise,
    ...
    return NextResponse.json({
      success: true,
      message: `Next.js test kategorisi başarıyla oluşturuldu. Test içeriği daha sonra eklenecek.`,
      stats: {
        testsCreated: 1,
      },
    });
