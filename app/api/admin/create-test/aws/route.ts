...
export async function POST() {
  try {
    ...
    console.log("[CREATE_TEST_API] Starting AWS test creation...");
    ...
    try {
      const fileName = TEST_MODULE_FILE_MAP[expertise] || "aws-test-modules.json";
    ...
    return NextResponse.json({
      success: true,
      message: `AWS testleri başarıyla oluşturuldu. ${modules.length} modül, ${totalTests} test eklendi.`,
      stats: {
