      ...
      <div className="relative flex-1 min-w-[150px]">
        ...
        <div className="relative">
          <select
            ...
            className="w-full px-3 py-1.5 pr-8 text-sm rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-500 appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
