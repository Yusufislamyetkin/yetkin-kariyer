  ...
  return (
    <div className="bg-white text-gray-900 break-words overflow-hidden" style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div className="max-w-5xl mx-auto p-4 flex-1 overflow-hidden" style={{ display: 'flex', flexDirection: 'column' }}>
        <div className="bg-gray-800 text-white p-4 mb-2 flex-shrink-0">
          <h1 className="text-2xl font-bold mb-1">{data.personalInfo.name || "Ad Soyad"}</h1>
          <div className="grid md:grid-cols-2 gap-2 text-gray-300 text-xs">
        ...
        <div className="grid md:grid-cols-3 gap-4 flex-1 overflow-hidden" style={{ minHeight: 0 }}>
          <div className="md:col-span-2 space-y-2 overflow-y-auto" style={{ maxHeight: '100%' }}>
            {data.experience.length > 0 && (
              <section>
                <h2 className="text-lg font-bold text-gray-800 mb-2 border-b-2 border-gray-800 pb-1">İş Deneyimi</h2>
            ...
            {data.education.length > 0 && (
              <section>
                <h2 className="text-lg font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Eğitim</h2>
          ...
          <div className="space-y-2 overflow-y-auto" style={{ maxHeight: '100%' }}>
            {data.skills.length > 0 && (
              <section>
                <h2 className="text-base font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Beceriler</h2>
                <div className="space-y-1">
            ...
            {data.certifications.length > 0 && (
              <section>
                <h2 className="text-base font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Sertifikalar</h2>
                <div className="space-y-1">
            ...
            {data.languages.length > 0 && (
              <section>
                <h2 className="text-base font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Diller</h2>
                <div className="space-y-1">
            ...
            {data.projects.length > 0 && (
              <section>
                <h2 className="text-base font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Projeler</h2>
                <div className="space-y-1">
            ...
            {data.achievements.length > 0 && (
              <section>
                <h2 className="text-base font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Başarılar</h2>
                <div className="space-y-1">
            ...
            {data.hobbies.length > 0 && (
              <section>
                <h2 className="text-base font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Hobiler</h2>
            ...
            {data.references.length > 0 && (
              <section>
                <h2 className="text-base font-bold text-gray-800 mb-1 border-b-2 border-gray-800 pb-1">Referanslar</h2>
                <div className="space-y-1">
