    ...
    <div className="bg-white text-gray-900 break-words">
      <div className="max-w-5xl mx-auto p-8">
        ...
        {data.experience.length > 0 && (
          <section className="mb-8">
            <h2 className="text-xl font-bold text-blue-600 mb-4 border-b-2 border-blue-600 pb-1">Professional Experience</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            {data.education.length > 0 && (
              <section className="mb-8">
                <h2 className="text-xl font-bold text-blue-600 mb-4 border-b-2 border-blue-600 pb-1">Education</h2>
                <div className="space-y-3">
                  {data.education.map((edu, i) => (
                    <div key={i} className="border-l-4 border-blue-600 pl-4">
                      <h3 className="font-semibold text-gray-900">{edu.degree}</h3>
                      <p className="text-blue-700 text-sm">{edu.school}</p>
                    </div>
                  ))}
                </div>
              </section>
          ...
          <div>
            {data.skills.length > 0 && (
              <section className="mb-8">
                <h2 className="text-xl font-bold text-blue-600 mb-4 border-b-2 border-blue-600 pb-1">Skills</h2>
            ...
            {data.languages.length > 0 && (
              <section>
                <h2 className="text-xl font-bold text-blue-600 mb-4 border-b-2 border-blue-600 pb-1">Languages</h2>
