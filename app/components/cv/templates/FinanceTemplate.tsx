      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        {data.summary && (
          <section className="mb-8">
            <h2 className="text-xl font-bold text-blue-900 mb-3 border-b-2 border-blue-800 pb-1">Özet</h2>
            <p className="text-gray-700 leading-relaxed break-words whitespace-pre-line">{data.summary}</p>
          </section>
        )}
        {data.experience.length > 0 && (
          <section className="mb-8">
            <h2 className="text-xl font-bold text-blue-900 mb-4 border-b-2 border-blue-800 pb-1">İş Deneyimi</h2>
        ...
        {data.education.length > 0 && (
          <section className="mb-8">
            <h2 className="text-xl font-bold text-blue-900 mb-4 border-b-2 border-blue-800 pb-1">Eğitim</h2>
        ...
        {data.skills.length > 0 && (
          <section className="mb-8">
            <h2 className="text-xl font-bold text-blue-900 mb-4 border-b-2 border-blue-800 pb-1">Beceriler</h2>
        ...
        {data.certifications.length > 0 && (
          <section className="mb-8">
            <h2 className="text-xl font-bold text-blue-900 mb-4 border-b-2 border-blue-800 pb-1">Sertifikalar</h2>
