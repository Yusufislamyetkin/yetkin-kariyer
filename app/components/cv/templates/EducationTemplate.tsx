      ...
      <div className="max-w-4xl mx-auto p-4 flex-1 overflow-hidden" style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="flex-1 overflow-y-auto" style={{ minHeight: 0 }}>
          ...
          {data.education.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-2 border-b-2 border-blue-600 pb-1">Eğitim</h2>
          ...
          {data.experience.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-2 border-b-2 border-blue-600 pb-1">Deneyim</h2>
          ...
          {data.certifications.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-1 border-b-2 border-blue-600 pb-1">Sertifikalar</h2>
              <div className="space-y-1">
          ...
          {data.skills.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-1 border-b-2 border-blue-600 pb-1">Beceriler</h2>
          ...
          {data.languages.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-1 border-b-2 border-blue-600 pb-1">Diller</h2>
              <div className="space-y-1">
          ...
          {data.projects.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-1 border-b-2 border-blue-600 pb-1">Projeler</h2>
              <div className="space-y-1">
          ...
          {data.achievements.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-1 border-b-2 border-blue-600 pb-1">Başarılar</h2>
              <div className="space-y-1">
          ...
          {data.hobbies.length > 0 && (
            <section className="mb-2">
              <h2 className="text-lg font-bold text-blue-600 mb-1 border-b-2 border-blue-600 pb-1">Hobiler</h2>
              <div className="flex flex-wrap gap-1">
          ...
          {data.references.length > 0 && (
            <section>
              <h2 className="text-lg font-bold text-blue-600 mb-1 border-b-2 border-blue-600 pb-1">Referanslar</h2>
              <div className="space-y-1">
