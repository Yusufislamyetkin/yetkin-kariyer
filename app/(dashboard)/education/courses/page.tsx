                ...
                >
                  ...
                  <div className="relative z-10 p-6 text-left h-full flex flex-col">
                    ...
                    <div className="flex items-center text-xs text-white/60">
                      ...
                      <span>{course.moduleCount} Modül • {course.totalLessons} Ders</span>
                    </div>
                  </div>
        ...
        <div className="flex flex-col gap-6 sm:gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-4 sm:space-y-5 lg:max-w-2xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-xl">
              Kariyerinizi ilerletmek için ihtiyacınız olan tüm kurslar tek bir yerde. 
              Adım adım öğrenin, projeler yapın ve uzmanlaşın.
            </p>
          </div>
          <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:w-auto lg:flex-shrink-0">
